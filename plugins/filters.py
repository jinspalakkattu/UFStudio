...
async def cb_handler(client: Bot, query: CallbackQuery):
    ...
    if (clicked == typed) or (clicked in AUTH_USERS):
        ...
        if query.data.startswith("next"):
            ...
            keyboard = InlineKeyboardMarkup([
                [InlineKeyboardButton("BACK", callback_data="start_data"),
                    InlineKeyboardButton("ABOUT", callback_data="about_data")],
                [InlineKeyboardButton("⭕️ SUPPORT ⭕️", url="https://t.me/lnc3f3r")]
            ])
            ...
            keyboard = InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("SOURCE CODE", url="https://github.com/jinspalakkattu/UFStudio")]
            ])
        ...
        await query.answer("ഇത്‌ നിനക്കുള്ളതല്ല!! \nThats not for you!!",show_alert=True)
